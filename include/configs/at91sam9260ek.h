...
#define	CONFIG_GREEN_LED	AT91_PIN_PB22	/* this is the user led */
...
#define MTDIDS_DEFAULT "nand=atmel_nand"
#define MTDPARTS_DEFAULT  "mtdparts=atmel_nand:128k(bootstrap)ro,1664k(u-boot),"         \
	"256k(u-bootenv),6m(kernel),60m(rootfs),-(data) "			 
					 
 


 
#undef CONFIG_ATMEL_NAND_HWECC		 
#undef CONFIG_ATMEL_NAND_HW_PMECC	 
...
#define CONFIG_ETHADDR                 30:31:32:33:34:35 
#define CONFIG_NETMASK                 255.255.255.0
#define CONFIG_IPADDR                  192.168.1.10
#define CONFIG_GATEWAYIP               192.168.1.1
#define CONFIG_SERVERIP                192.168.1.102 
/* define CONFIG_DRVER_AT91EMAC_PHYADDR  */
...
#define CONFIG_SYS_LOAD_ADDR			0x20008000	/* load address */

#define CONFIG_SYS_MEMTEST_START		CONFIG_SYS_SDRAM_BASE
#define CONFIG_SYS_MEMTEST_END			0x21F00000
...
#define CONFIG_BOOTCOMMAND	"cp.b 0xC0084000 0x20600000 0x210000; bootm"
...
#define CONFIG_BOOTCOMMAND	"nand read 0x20008000 0x200000 0x600000; bootm 0x20008000"
#define CONFIG_BOOTARGS                                                 \
        "mtdparts=atmel_nand:128k(bootstrap)ro,1664k(u-boot)ro,"         \
	"256k(u-bootenv),6m(kernel)ro,60m(rootfs),-(data) "  \
	"root=1f04 noinitrd rootfstype=yaffs2 init=/linuxrc mem=32M "   \
